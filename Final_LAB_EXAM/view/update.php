...
<html lang="en">
    ...
    <body>
        <fieldset>
            <legend style="font-size: 30px; text-align:center;"><b>Employer Registration</b></legend>
            <table style="font-size: 30px;">
                ...
                <tr>
                    ...
                    <td>
                        <br>
                        <input type="submit" name="submit" onclick="" value="Registration" style="font-size: 20px; cursor:pointer;">
                        &nbsp&nbsp&nbsp&nbsp
